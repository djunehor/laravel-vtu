...
class UnikMobileNig extends Vtu
{
    private $baseUrl = 'https://unikmobileng.com/';
    private $orderId = 0;


    public function __construct($username = null, $password = null)
    {
        $this->username = $username ?? config('laravel-vtu.unik_mobile.username');
        $this->password = $password ?? config('laravel-vtu.unik_mobile.password');
